...
public class CameraFragmentDirections {
  ...
  @NonNull
  public static ActionCameraToJpegViewer actionCameraToJpegViewer() {
    return new ActionCameraToJpegViewer();
  }

  public static class ActionCameraToJpegViewer implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionCameraToJpegViewer() {
    }
